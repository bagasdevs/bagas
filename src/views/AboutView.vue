      ...
      <section
        ...
        <div class="flex justify-center">
          <img class="w-9/12 rounded-full mb-3 fadein-up"
            src="https://imgtr.ee/images/2023/09/29/ba8f66ba3399b99bf6dd0cc2f7fb2296.png" alt="Foto">
        </div>
        <div class="md:w-7/12">
          <p class="mb-3 md:mb-7 fadein-left fadeins-1">
            &nbsp; &nbsp; &nbsp; Hi everyone! My name is Bagas Cahya Pamungkas. I'm a web developer from Magelang, Central Java. I
            have 2.5 year of experience in back-end web development.
